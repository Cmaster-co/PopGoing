      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="/index.php/admin/whmanage"><i class="fa fa-bar-chart fa-fw"></i>网红管理</a></li>
                <li><a href="/index.php/admin/producemanage" class="active"><i class="fa fa-database fa-fw"></i>商家管理</a></li>
