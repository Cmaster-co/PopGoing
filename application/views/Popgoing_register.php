...
<div id="skrollr-body">
    <section id="hero" class="flex">
        ...
        <article>
            ...
            <form class="form-signin" method="post" action="/index.php/user/registP">
                <h2>注册</h2>
                <p></p>
                <p></p>
                <br/>
                <br/>
                <label for="inputEmail" class="sr-only">用&nbsp;&nbsp;户&nbsp;&nbsp;名</label>
                ...
                <p></p>
                <label for="inputEmail" class="sr-only">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机</label>
                <input type="tel" id="phone" class="form-control" placeholder="Phone" required="" autofocus="">
                <p></p>
                <label for="inputEmail" class="sr-only">收获地址</label>
                ...
                <input type="password" id="inputPassword1" name="passwd" class="form-control" placeholder="Password" required="">
                <p></p>
